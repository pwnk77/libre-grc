...
export const TasksTab: React.FC<{ secureByDesignId: string }> = ({ secureByDesignId }) => {
      ...
      permanent: [
        {
          ...
          operator: "eq",
          value: secureByDesignId,
        },
        {
          field: "entity_type",
          operator: "eq",
          value: "secure_by_design",
        },
      ],
    },
    sorters: {
  ...
  const onFinish = async (values: any) => {
    createTask({
      ...
      values: {
        ...values,
        related_entity_id: secureByDesignId,
        entity_type: "secure_by_design",
        task_type: "SecureByDesign",
